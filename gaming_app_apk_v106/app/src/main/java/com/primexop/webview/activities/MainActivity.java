...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.addJavascriptInterface(new JavaScriptInterface(this,webView,window,horizontalProgressFrameLayout), "Android");
...
//        webView.loadUrl("http://192.168.100.9:5500/test.html");

        // disable log press click in react apps
